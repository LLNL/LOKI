...
c
c Fortran functions called by InterspeciesCollisionOperator.
c

      subroutine computeInterspeciesConstants(
     *     khat, hhat, vx, vy,
...
c +++++++++++++
c
      subroutine computeInterspeciesTemps(
     *     fM, uMomx, uMomy, uKE,
...
c +++++++++++++
c
      subroutine computeInterspeciesDenoms(
     *     rMomx, rMomy, rKE,
     *     cMomx, cMomy, cKE,
     *     nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,
     *     n1a,n1b,n2a,n2b,n3a,n3b,n4a,n4b,
...
c +++++++++++++
c
      subroutine computeInterspeciesNumerators(
     *     rMomx, rMomy, rKE,
...
c +++++++++++++
c
      subroutine appendInterspeciesBackReaction(
     *     rhs,
     *     cMomx, cMomy, cKE,
     *     IMomxN, IMomyN, IKEN,
     *     IMomxD, IMomyD, IKED,
...
c +++++++++++++
c
      subroutine appendInterspeciesCollision(
     *     rhs,f,vx,vy,Kh,Hh,
     *     nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,
     *     n1a,n1b,n2a,n2b,n3a,n3b,n4a,n4b,
     *     xlo, xhi, dx,
     ...
     *     iparams)
c
c.. compute and add the Interspecies collision operator to the RHS ...
      implicit none
c
c.. declarations of incoming variables 
      integer nd1a, nd1b, nd2a, nd2b, nd3a, nd3b, nd4a, nd4b
...
c
      if( solution_order .eq. 4 ) then
        ! 4th order
        call appendInterspeciesCollision_4th(
     *     rhs,f,vx,vy,Kh,Hh,
     *     nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,
     *     n1a,n1b,n2a,n2b,n3a,n3b,n4a,n4b,
     *     xlo, xhi, dx,
     ...
     *     iparams)
        ...
        ! 6th order
        call appendInterspeciesCollision_6th(
     *     rhs,f,vx,vy,Kh,Hh,
     *     nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,
     *     n1a,n1b,n2a,n2b,n3a,n3b,n4a,n4b,
     *     xlo, xhi, dx,
...
c +++++++++++++
c
      subroutine appendInterspeciesCollision_4th(
     *     rhs,f,vx,vy,Kh,Hh,
     *     nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,
     *     n1a,n1b,n2a,n2b,n3a,n3b,n4a,n4b,
     *     xlo, xhi, dx,
...
c +++++++++++++
c
      subroutine appendInterspeciesCollision_6th(
     *     rhs,f,vx,vy,Kh,Hh,
     *     nd1a,nd1b,nd2a,nd2b,nd3a,nd3b,nd4a,nd4b,
     *     n1a,n1b,n2a,n2b,n3a,n3b,n4a,n4b,
     *     xlo, xhi, dx,
